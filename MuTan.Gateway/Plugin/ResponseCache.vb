...
Namespace Plugin
	...
	Public Class ResponseCache
		Implements IRespondingHandler, Model.IPlugin, IPluginStatus
		...
		''' <summary>描述</summary>
		Public ReadOnly Property Description As String = "API 缓存（写缓存）" Implements IPlugin.Description
		...
		''' <summary>执行操作，写入缓存</summary>
		Public Sub Execute(e As EventRespondingArgs) Implements IRespondingHandler.Execute
